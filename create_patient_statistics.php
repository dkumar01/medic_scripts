<?php
	...
	*/
	...
	if (isset($_POST['patient_id']) && isset($_POST['date_of_submission']) && isset($_POST['glucose_level']) && isset($_POST['cholesterol']) && isset($_POST['weight']) && isset($_POST['comments'])) 
	{
		...
		//Inserting a new row
		$query = "INSERT INTO patient_statistics(patient_id, date_of_submission, glucose_level, cholesterol, weight, comments) VALUES($patient_id, '$date_of_submission', $glucose_level, $cholesterol, $weight, '$comments')";
